...
# 安装菜单函数
install_menu() {
    print_in_color $BLUE "欢迎使用hinas安装脚本,脚本均为hinas系统内置提供"
...
# 卸载菜单函数
uninstall_menu() {
    print_in_color $BLUE "欢迎使用hinas卸载脚本"
